...
@section('title', 'Tin Xem Nhiều Nhất')
...
<div class="container mx-auto py-8">
  <h1 class="text-3xl font-bold mb-6">Tin Xem Nhiều Nhất</h1>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    @foreach($news as $item)
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition">
        ...
        <div class="p-4">
          <a href="{{ route('news.show', $item->slug) }}"
             class="block text-lg font-semibold custom-link dark:text-gray-100 mb-2">
